    ...
    async def callback(self, interaction: discord.Interaction):
        if self.invoker == interaction.user:
            ...
            await interaction.response.send_message(
                "❌ Hey, you can't control this!", ephemeral=True)
...
class View(discord.ui.View):
    ...
    def add_buttons(self):
        ...
        self.endB = Buttons(label="≫",
                            ...
                            ctx=self.ctx)
        self.quitB = randi(emoji="<:anxCross:1107932430322647144>",
    ...
    def gen_embeds(self):
        ...
        options.append(
            discord.SelectOption(label="Home",
                                 emoji='<:anxHome:1108101895836418218>', description="Back to Main Menu."))
